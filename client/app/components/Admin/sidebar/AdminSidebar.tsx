        ...
        <Menu iconShape='square'>
          ...
          >
            { !isCollapsed && (
              ...
              >
                <Link href="/">
                  <h3 className='text-[25px] font-Poppins uppercase dark:text-white text-[#0F172A]'>
                    9rayti
                  </h3>
                </Link>
                <IconButton onClick={() => setIsCollapsed(!isCollapsed)} className='inline-block'>
                  <ArrowBackIosIcon className='text-[#0F172A] dark:text-[#ffffffc1]'/>
                </IconButton>
              </Box>
            )}
          </MenuItem>
          ...
          {!isCollapsed && (
            <Box mb="25px">
              ...
              <Box textAlign="center">
                <Typography 
                  variant='h4'
                  className='!text-[20px] text-[#0F172A] dark:text-[#ffffffc1]'
                  sx={{ m: "10px 0 0" }}
                >
                  {user?.name}
                </Typography>
