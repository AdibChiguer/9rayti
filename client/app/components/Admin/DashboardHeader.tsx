    ...
    <div className="w-full flex items-center justify-end p-6 fixed top-5 right-0">
      ...
      {open && (
        <div className="w-[350px] h-[50vh] dark:bg-[#111c43] bg-white shadow-xl absolute top-16 z-10 rounded-[10px]">
          ...
          <div className="dark:bg-[#2d3a4ea1] bg-[#00000013] font-Poppins border-b dark:border-b-[#ffffff47] border-b-[#000000f] w-[340px] m-auto rounded-[10px]">
            ...
            <p className="px-2 text-[#111c43] dark:text-white">
              ...
              Perferendis accusamus excepturi rem nesciunt hic? Eius, dolores
              illo,
            </p>
          ...
          {/* <div className="dark:bg-[#2d3a4ea1] bg-[#00000013] font-Poppins border-b dark:border-b-[#ffffff47] border-b-[#000000f] w-[340px] m-auto rounded-[5px]">
            <div className="w-full flex items-center justify-between p-2">
              <p className="text-[#111c43] dark:text-white">
                New Question Received
              </p>
