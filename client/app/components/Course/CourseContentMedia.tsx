...
const CourseContentMedia = ({ data , id , activeVideo , setActiveVideo , user , refetch }: Props) => {
  ...
  return (
    <div className='w-[95%] 800px:w-[86%] py-4 m-auto'>
      ...
      {
        activeBar === 0 && (
          <p className='text-[18px] whitespace-pre-line mb-3 dark:text-[#edfff4] text-[#0F172A] mx-4'>
          ...
          <div>
            {
              data[activeVideo]?.links.map((item: any , index: number) => (
                <div className='mb-5 mx-4' key={index}>
                  ...
                  <a href={item.url} className='inline-block text-[#4395c4] 800px:text-[20px]'>
                    {item.url}
                  </a>
                </div>
              ))
              ...
              <div className='w-full'>
                {
                  (course?.reviews && [...course?.reviews].reverse()).map((item:any , index:number) => (
                    <div className='w-full my-5 dark:text-[#edfff4] text-[#0F172A]' key={index}>
                      ...
                      </div>
                      {
                        user.role === "admin" && (
                          ...
                          >
                            Add Reply <BiMessage size={20} className='cursor-pointer' />
                          </span>
                        )
                      }
                      {
                        isReviewReply && (
                          <div className='w-full flex relative'>
                            ...
                            <button
                              ...
                              onClick={replyCreationLoading ? () => {} : handleReviewReplySubmit}
                          ...
                          <div className='w-full flex 800px:ml-16 my-5 dark:text-[#edfff4] text-[#0F172A]' key={index}>
                            ...
                            <div className='pl-3'>
                              <div className="flex items-center">
                                ...
                                {
                                  i.user.role === "admin" && <VscVerifiedFilled className='text-[#0095f6] ml-2 text-[20px]'/>
                                }
                              </div>
                              <p>{i.comment}</p>
                              <small className='dark:text-[#edfff4] text-[#0F172A]'>
              ...
              <>
                <div className='w-full flex relative dark:text-[#edfff4] text-[#0F172A]'>
                  <input 
                    ...
                    className={`block 800px:ml-12 mt-2 outline-none bg-transparent border-b dark:border-[#fff] border-[#0F172A] p-[5px] w-[95%] dark:text-[#edfff4] text-[#0F172A] ${answer === "" || answerCreationLoading && "cursor-not-allowed"}`}
                  />
                  <button
                    type='submit'
                    className='absolute right-0 bottom-0'
